...
class Controller
{
    ...
    /**
     * TODO Роман Науменко: Использовать MapEntity не рекомендую, так как это нарушает границы архитектурных слоев.
     *  Во-первых, контроллеры не должны знать о сущностях из слоя домена
     *  Во-вторых, MapEntity использует доктрину напрямую, минуя наши репозитории.
     *       А репозитории должны быть единственной точкой доступа к данными и абстрагировать внутри себя работу с Doctrine
     */
