<?php
    ...
    namespace bravik\Sales\Tests\Domain\UseCases\Commands\Invoices\Pay;
    ...
    use bravik\Sales\Domain\UseCases\Commands\Invoices\Pay\Command;
    use bravik\Sales\Domain\UseCases\Commands\Invoices\Pay\Handler;
